import { Earth, LayoutDashboard, List, User } from "lucide-react";
        ...
        <nav className="space-y-2">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={`transition-colors ${isActive ? "text-emerald-400" : "text-slate-500 group-hover:text-white"}`}>
                  {item.icon}
                </span>
